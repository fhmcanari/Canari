        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              SizedBox(height: 30,),
              Text('Canari Food and More تحتاج إلى تحديث',style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600, fontSize: 14),),
              SizedBox(height: 20,),
              Padding(
                padding: const EdgeInsets.only(left: 30,right: 30),
                child: Text('لاستخدام هذا التطبيق ، تحتاج إلى تنزيل أحدث إصدار ، يرجى تحديث التطبيق الآن',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w600, fontSize: 14,height: 2),textAlign: TextAlign.center),
              ),
              SizedBox(height: 30,),
              Padding(
                padding: const EdgeInsets.only(left: 30,right: 30),
